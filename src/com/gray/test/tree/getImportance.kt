...
data class Employee(val id: Int, val importance: Int, val subordinates: List<Int>?)

fun getImportance(employees: List<Employee>, id: Int): Int {
    val dict = hashMapOf<Int, Employee>()
    for (employee in employees) {
        dict[employee.id] = employee
    }
    fun dfs(eid: Int): Int {
        val employee = dict[eid]!!
        var ret = employee.importance
